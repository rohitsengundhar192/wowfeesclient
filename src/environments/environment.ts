...
// const baseURL = 'https://u60api.getwow.community/api/';
...
export const environment = {
  ...
  createTable:
    baseURL + 'fee-management-with-tally/app-administration/create-table',
  insertFeeCategory:
    baseURL +
  ...
  getCategoryNameByUserIDNew:
    baseURL +
    'fee-management-with-tally/schedule-fee-discount-to-students/get-category-name-by-user-id-new',
  getNameBySingleCategory:
    baseURL +
    'fee-management-with-tally/schedule-fee-discount-to-students/get-category-name-by-single-category',
  getNameByUserID:
    baseURL +
  ...
  getDateStudentWiseTable:
    baseURL +
    'fee-management-with-tally/fee-collection-balance-remainder/get-due-date-student-wise-table',
