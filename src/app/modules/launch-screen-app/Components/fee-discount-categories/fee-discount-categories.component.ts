...
@Component({
  selector: 'app-fee-discount-categories',
  templateUrl: './fee-discount-categories.component.html',
  styleUrls: ['./fee-discount-categories.component.scss'],
})
export class FeeDiscountCategoriesComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
