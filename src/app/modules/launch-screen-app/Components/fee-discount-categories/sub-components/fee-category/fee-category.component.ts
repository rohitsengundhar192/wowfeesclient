...
import { FeeAssignNewComponent } from '../../popups/fee-assign-new/fee-assign-new.component';
import { ApiService } from 'src/app/shared/services/api/api.service';
import { FeeAssignEditComponent } from '../../popups/fee-assign-edit/fee-assign-edit.component';
...
export class FeeCategoryComponent implements OnInit {
  ...
  OpenAddAssignNew() {
    const dialogRef = this.dialog.open(FeeAssignNewComponent, {
      disableClose: true,
      height: '50%',
      width: '450px',
      minWidth: '250px',
  ...
  OpenAddAssignEdit() {
    const dialogRef = this.dialog.open(FeeAssignEditComponent, {
      disableClose: true,
      height: '50%',
      width: '450px',
      minWidth: '250px',
