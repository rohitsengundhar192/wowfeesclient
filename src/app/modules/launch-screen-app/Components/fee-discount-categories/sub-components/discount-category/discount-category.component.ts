...
import { DiscountAssignNewComponent } from '../../popups/discount-assign-new/discount-assign-new.component';
import { DiscountAssignEditComponent } from '../../popups/discount-assign-edit/discount-assign-edit.component';
...
export class DiscountCategoryComponent implements OnInit  {
  ...
  getFeeCategoryTable() {
    this._apiservice
      .getDiscountCategoryTable(this.country_code, this.customer_id)
      .subscribe((res) => {
        console.log(res, 'ree');
  ...
  OpenDiscountAssignNew() {
    const dialogRef = this.dialog.open(DiscountAssignNewComponent, {
      disableClose: true,
      height: '50%',
      width: '470px',
      minWidth: '250px',
  ...
  OpenDiscountAssignEdit() {
    const dialogRef = this.dialog.open(DiscountAssignEditComponent, {
      disableClose: true,
      height: '50%',
      width: '560px',
      minWidth: '250px',
