...
@Component({
  selector: 'app-schedule-fee-discount-to-students',
  templateUrl: './schedule-fee-discount-to-students.component.html',
  styleUrls: ['./schedule-fee-discount-to-students.component.scss']
})
export class ScheduleFeeDiscountToStudentsComponent implements OnInit  {
  //* --------------------------  Start  -----------------------------------*//
