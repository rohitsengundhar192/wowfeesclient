...
@Component({
  selector: 'app-list-category-student',
  templateUrl: './list-category-student.component.html',
  styleUrls: ['./list-category-student.component.scss'],
})
export class ListCategoryStudentComponent implements OnInit {
  //* ------------------------------  START  ------------------------------ *//
  ...
  //* ------------------------------  APIs Methods  ------------------------------ *//
  ngDoCheck(): void {
    // console.log(this.selected_category_val);
  }
  ...
  todoLeafItemSelectionToggle(node: TreeData): void {
    ...
    console.log(this.selected_category_val, 'val');
    ...
    this._dataSharingService.shareCategoryScheduleNewStudent(
      this.selected_category_val
    );
