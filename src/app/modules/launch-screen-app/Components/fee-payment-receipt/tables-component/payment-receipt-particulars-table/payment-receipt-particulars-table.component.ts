...
@Component({
  selector: 'app-payment-receipt-particulars-table',
  templateUrl: './payment-receipt-particulars-table.component.html',
  styleUrls: ['./payment-receipt-particulars-table.component.scss'],
})
export class PaymentReceiptParticularsTableComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
