...
@Component({
  selector: 'app-fee-particulars-table',
  templateUrl: './fee-particulars-table.component.html',
  styleUrls: ['./fee-particulars-table.component.scss'],
})
export class FeeParticularsTableComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
