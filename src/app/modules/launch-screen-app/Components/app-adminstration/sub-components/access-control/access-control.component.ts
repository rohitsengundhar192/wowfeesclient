...
export class AccessControlComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._dataShare.share_data_bt_access_to_deny_table_data.subscribe((res) => {
      if (res == 1) {
        this.getTableData();
      }
    });
  ...
  getTableData() {
    this._apiService
      .getDenyAccessTable(this.country_code, this.customer_id)
      .subscribe((res) => {
  ...
  deleteData() {
    ...
    this._apiService
      .deleteDenyAccess(this.country_code, this.customer_id, user_ids)
      .subscribe((res) => {
        if (res.statusCode == 200) {
          this._snackbar.success('Data Updated Succesful');
          this.getTableData();
          this._dataShare.shareDataBtDenytoAccessTable(2);
          this.selection.selected.length=0;
          this.DenyBtnDisable = true;
          user_ids=[];
        }
      });
  }
