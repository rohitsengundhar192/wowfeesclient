...
@Component({
  selector: 'app-app-adminstration',
  templateUrl: './app-adminstration.component.html',
  styleUrls: ['./app-adminstration.component.scss'],
})
export class AppAdminstrationComponent implements OnInit {
  //* --------------------------  Start  -----------------------------------*//
